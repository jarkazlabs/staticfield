      ...
      <button onClick={onClick} className="text-left w-full">
        <div className="aspect-video w-full rounded-lg overflow-hidden bg-ss-surface mb-3 border border-ss-border card-hover relative">
          {board.imageUrl
            ...
            : <div className="w-full h-full flex items-center justify-center"><span className="text-ss-ghost text-3xl">◻</span></div>
          }
          {board.isDemo && (
  ...
  return (
    <div className="min-h-screen pt-14 bg-ss-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-10 sm:pt-14 pb-8 sm:pb-10 border-b border-ss-border flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 py-8 sm:py-10 pb-20">
          {boards.map((board, i) => (
      ...
      {showModal && <AddBoardModal onAdd={handleAddBoard} onClose={() => setShowModal(false)} />}
    </div>
  )
}
