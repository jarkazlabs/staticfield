// AddBoardModal.jsx — Neues Board erstellen
import { useState } from 'react'

export default function AddBoardModal({ onAdd, onClose }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm"
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm mx-4">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-ss-border">
          <h2 className="font-sans font-semibold text-ss-ink text-sm">Neues Board</h2>
        ...
        <div className="p-5 flex flex-col gap-4">
          ...
          <div>
            <label className="text-xs font-semibold text-ss-dim uppercase tracking-wide block mb-1.5">Beschreibung (optional)</label>
