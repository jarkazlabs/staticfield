export default function Footer({ setPage }) {
  ...
  return (
    <footer className="min-h-[190px] bg-ss-ink px-4 sm:px-6 py-14 sm:py-16 text-white">
      <div className="max-w-7xl mx-auto min-h-[76px] flex flex-col md:flex-row md:items-end justify-between gap-10">
